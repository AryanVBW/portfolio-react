...
import footerAvatar from '../assets/png/footer-avatar-vivek.png';
...
function Footer() {
  ...
  useEffect(() => {
    ...
    // Eye movement animation for footer avatar
    ...
    const mouseMove = (e) => {
      ...
      fracXValue = currentXPosition / (mouseXEndPoint - mouseXStartPoint);
      fracYValue = (currentYPosition = e.clientY) / mouseYEndPoint;

      let pupilXValue = pupilStartPoint + (fracXValue * pupilRangeX);
      let pupilYValue = pupilStartPoint + (fracYValue * pupilRangeY);

      pupilsArr.forEach((pupil) => {
        pupil.style.transform = `translate(${pupilXValue}px, ${pupilYValue}px)`;
      });
    };
  ...
  return (
    <footer id="footer">
      <button className="fas" id="backtotopbutton" onClick={scrollToTop}>
      ...
      <div className="footer-foreground">
        <div className="footercontainer">
          ...
          <div className="social-media-container">
            ...
            <div className="logos">
              <a href="https://www.instagram.com/aryan_technolog1es" target="_blank" rel="noreferrer" tabIndex="0"
              ...
              <a href="https://www.linkedin.com/in/v.i.v.e.k_w?original_referer=" target="_blank" rel="noreferrer"
                aria-label="My Linkdin">
              ...
              <a href="https://github.com/AryanVBW" target="_blank" rel="noreferrer" aria-label="My github">
              ...
              <a href="mailto:vivek.aryanvbw@gmail.com" target="_blank" rel="noreferrer" aria-label="My G mail">
          ...
          <div className="footer-avatar-container">
            <img src={footerAvatar} alt="animation-head" className="footer-avatar-img" id="footer-wala-avatar"/>
